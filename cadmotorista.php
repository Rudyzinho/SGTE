...
<body>
	...
	<header id="header">
				<div class="inner">
					<a href="index.html" class="logo">SGT</a>
				</div>
			</header>
		...
		<!-- Main -->
			<section id="main" >
				<div class="inner">
					...
					<form method="post" action="menuadm.html">
...
<div style="background-color: #28617D; color: #e9ede1; width: 100%; height:1px;">
		...
		<div style="background-color: #e9ede1; color: #28617D;">
			...
			<footer class="my-5 pt-5 text-muted text-center text-small">
   				<center> 
   					<p class="mb-1"><br><br>
   					&copy;Yasmim Milhome, Erik Elvis, Willas Nascimento, Vitória Costa, Ruan Pinheiro e Sarah Rebeca</p>
